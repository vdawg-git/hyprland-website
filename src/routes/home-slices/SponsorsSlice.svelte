...
{#if hasSponsors}
	<section class="relative mb-12 flex max-w-5xl flex-col gap-8 px-8 md:mb-20">
		<Title class="px-0">
			...
			<TitleHeading slot="title">Our sponsors</TitleHeading>
		</Title>

		<div class="relative flex max-w-[1024px] select-none flex-col justify-center text-slate-100">
			<div class="flex min-h-max flex-col gap-20 text-sm">
				...
				{#if sponsors.platinum.length > 0}
					<div class="flex flex-col gap-6 rounded-xl">
						<h2
							class="bg-gradient-to-r bg-clip-text text-center text-xl font-bold text-blue-300 text-transparent"
						>
							Platinum
						</h2>
						<div class="flex justify-center gap-14 md:gap-16">
			...
			<a
				...
				class="group mt-16 self-center text-center text-slate-300 decoration-primary hover:underline"
			>
				Interested in sponsoring? <span class="text-cyan-400 group-hover:text-cyan-300"
